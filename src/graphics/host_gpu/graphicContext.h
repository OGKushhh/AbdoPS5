...
struct GraphicContext {
        ...
        // Kyty-vulkan-relax: tracks which Vulkan extensions the device
        // actually supports, so device creation can skip requesting the
        // missing ones (instead of failing with VK_ERROR_FEATURE_NOT_PRESENT).
