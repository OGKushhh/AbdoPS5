...
enum class GameHack : uint32_t {
        ...
        // Audio hacks
        BloodborneAudioFix     = 1u << 13u, // Prevent audio loss in Bloodborne (rainvmaker's fix from shadPS4 Shadlix fork)

        // PM4 hacks
        Pm4Type0Fix             = 1u << 14u, // PM4 Type 0 packet handling fix (Bloodborne)
};
