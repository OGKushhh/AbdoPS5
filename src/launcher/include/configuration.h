...
public:
        ...
        // Kyty-vulkan-relax: makes missing Vulkan extensions optional
        // instead of device-rejection errors. For older GPUs (e.g. Pascal
        // GTX 10-series lacks fragmentShaderBarycentric). May cause
        // visual glitches but lets the emulator boot.
        ...
        void CopyEmulatorSettingsFrom(const Configuration& other) {
                ...
                vulkan_relax_requirements   = other.vulkan_relax_requirements;
        ...
        void WriteSettings(QSettings* s) const {
                ...
                KYTY_CFG_SET(vulkan_relax_requirements);
        ...
        void ReadSettings(QSettings* s) {
                ...
                vulkan_relax_requirements = s->value("vulkan_relax_requirements", vulkan_relax_requirements).toBool();
