...
//
// Promoted from QWidget to QDialog so callers can use exec() for a proper
// modal interaction. Previously was QWidget, which broke compilation
// because QWidget has no exec() method.
//
// Two tabs:
